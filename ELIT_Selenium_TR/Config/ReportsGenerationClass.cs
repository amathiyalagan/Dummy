...
namespace ELIT_Selenium_TR.Config
{
    ...
    public abstract class ReportsGenerationClass
    {
        ...
        protected void Setup()
        {
            ...
            _extent.AddSystemInfo("UserName", "Sreekanth Chinnakkagari");
        }
        ...
        public void BeforeTest()
        {
            ...
            _driver = new ChromeDriver(@"C:\Users\ATSTC004\Desktop\repos\ELIT_Selenium_TR\ELIT_Selenium_TR\Driver\", options);  //Location of Chrome Driver.EXE in the project
